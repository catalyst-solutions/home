<template>
  <Wrapper class="flex flex-col gap-12">
    <Text size="title"> Impressum </Text>
    <div class="border-b border-slate-200 pb-12 grid lg:grid-cols-2 gap-6">
      <Text size="heading">Kontakt</Text>
      ...
      <Text class="w-2/3">
        ...
        Noah Cofie<br /><br />
        Kontakt:<br />
        Telefon: +49 15238448010<br />
        E-Mail: contact@csol.dev<br /><br />
        Haftungsausschluss:<br />
        Website Impressum erstellt durch impressum-generator.de von der Kanzlei
        Hasselbach
      </Text>
    </div>

    <div class="border-b border-slate-200 pb-12 grid lg:grid-cols-2 gap-6">
      <Text size="heading">Haftung für Inhalte</Text>
    ...
    <div class="border-b border-slate-200 pb-12 grid lg:grid-cols-2 gap-6">
      <Text size="heading">Haftung für Links</Text>
    ...
    <div class="border-b border-slate-200 pb-12 grid lg:grid-cols-2 gap-6">
      <Text size="heading"> Google Analytics</Text>
